...
async def start(client, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton(" Developer ", url='https://github.com/BINOD-XD')
        ],[
        InlineKeyboardButton(' Updates', url='https://t.me/teamrxs'),
        InlineKeyboardButton(' Support', url='https://t.me/mrboombastics4')
        ],[
        InlineKeyboardButton(' About', callback_data='about'),
        InlineKeyboardButton(' Help', callback_data='help')
        ],[ 
        InlineKeyboardButton(" Join Our Mod App Channel", url='https://t.me/teamrxs')
        ],[
        InlineKeyboardButton("Follow Github", url='https://github.com/BINOD-XD')
        ]
        ])
    if START_PIC:
